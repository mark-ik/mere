    ...
    pub fn repulse_only(&self) {
        ...
        unsafe {
            kernels::repulse::launch_unchecked::<WgpuRuntime>(
                ...
                BufferArg::from_raw_parts(self.positions.clone(), count * 4),
                BufferArg::from_raw_parts(self.forces.clone(), count * 4),
                self.params.n,
    ...
    fn dispatch(&mut self, own_repulsion: bool) {
        ...
        unsafe {
            kernels::clear_settle::launch_unchecked::<WgpuRuntime>(
                ...
                CubeDim::new_1d(1),
                BufferArg::from_raw_parts(self.settle.clone(), 1),
            );
        }
        if own_repulsion {
            self.repulse_only();
        ...
        unsafe {
            kernels::springs::launch_unchecked::<WgpuRuntime>(
                ...
                BufferArg::from_raw_parts(self.positions.clone(), count * 4),
                BufferArg::from_raw_parts(self.forces.clone(), count * 4),
                BufferArg::from_raw_parts(self.offsets.clone(), count + 1),
                BufferArg::from_raw_parts(self.targets.clone(), 1),
                self.params.n,
            ...
            kernels::integrate::launch_unchecked::<WgpuRuntime>(
                ...
                dim,
                BufferArg::from_raw_parts(self.positions.clone(), count * 4),
                BufferArg::from_raw_parts(self.velocities.clone(), count * 4),
                BufferArg::from_raw_parts(self.forces.clone(), count * 4),
                BufferArg::from_raw_parts(self.settle.clone(), 1),
                self.params.n,
                self.params.dt,
