...
//! field-layer truth the kernel owns and `aether` reads, and neither is a
...
//!
//! Ported from `aether::coupling` (field-system extraction Phase 4) so the kernel
//! owns every field-layer definition type; `aether` re-exports these. Derives are
