...
impl Command {
    ...
    pub fn verb(self) -> &'static str {
        match self {
            ...
            Command::HideSelectedEdge => "hide_link",
            Command::ShowAllEdges => "show_all_links",
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Command::HideSelectedEdge => "Hide selected link",
            Command::ShowAllEdges => "Show all links",
            ...
            Command::RetractEdge => "Unrelate selected link",
