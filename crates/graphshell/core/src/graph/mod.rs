...
// (`graphshell_core::graph::NodeKey`, etc.) continue to resolve;
...
// decomposition target. Re-exported so `graphshell_core::graph::Node`
...
// here so external paths (`graphshell_core::graph::Node`, etc.)
// resolve unchanged.
