...
mod tests {
    use super::*;
    use inker::{
        FocusReason, KeyboardEvent, MouseEvent, PointerEvent, SurfaceSettings,
    };
    ...
    impl SurfaceProducer for MockProducer {
        ...
        fn can_go_back(&self) -> bool { self.back_available }
        fn can_go_forward(&self) -> bool { self.forward_available }
