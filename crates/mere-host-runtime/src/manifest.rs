...
/// Identity of a persona — "whose sessions these are." v0 ships a
/// single hard-coded default persona; the persona-model brief will
/// promote this to multi-identity-per-user scope.
...
impl PersonaId {
    ...
    /// Fixed UUID so manifests are stable across app restarts
    /// before personas become user-managed.
