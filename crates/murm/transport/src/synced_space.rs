...
//!
//! [`SyncedSpace`] is the deduplicated core the near-identical copies under murm
//! (`gossip_sync`), mesh (`sync`), and — after the purity move — tessera all
//! shared: the drain loop over a subscribed p2panda-net LogSync stream, the real
