...
/// and slide off slopes into drifting dunes, draining at the bottom so it flows forever. A discrete
/// CA like Game of Life, but gravity-shaped - it pours and piles rather than oscillating in place.
/// (Physics scenes P5.)
pub struct SandFall {
    width: usize,
    height: usize,
...
mod tests {
    ...
    fn sand_falls_and_stays_bounded() {
        ...
        // Running the source + drain a while keeps grains flowing and the count bounded.
        for _ in 0..200 {
            sand.step();
        }
