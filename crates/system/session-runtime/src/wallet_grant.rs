...
fn upsert_remote_auth_wrapping_key(
    data_root: &Path,
    device_id: DeviceId,
...
fn remove_remote_auth_wrapping_key(data_root: &Path, device_id: DeviceId) -> io::Result<()> {
...
fn load_remote_auth_wrapping_key(
    data_root: &Path,
    device_id: DeviceId,
...
fn refresh_remote_auth_private_read_grants(
    data_root: &Path,
...
fn refresh_remote_auth_private_read_grant(
    data_root: &Path,
