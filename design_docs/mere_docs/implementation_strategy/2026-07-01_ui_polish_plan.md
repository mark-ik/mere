...
**Related**: [chrome_bar_refinement_plan](2026-06-26_chrome_bar_refinement_plan.md) (P4 moved sessions into toolbar chips, closeout retired the switcher thumbnails), [ui_dpi_scaling_plan](2026-06-26_ui_dpi_scaling_plan.md) (D1-D3 landed; this plan covers the surfaces it missed), `crates/meerkat/` (`views.rs`, `window_view/views.rs`, `tile_theme.rs`, `render/workbench.rs`, `render/orrery_scene.rs`, `app_state.rs`), `repos/serval/ports/pelt-desktop/tile_surface.rs`.
