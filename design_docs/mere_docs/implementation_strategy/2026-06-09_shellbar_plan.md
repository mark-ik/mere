...
**Date**: 2026-06-09
**Status**: In progress.
**Related**: [graph roster + frame taxonomy §4](../design/2026-06-07_graph_roster_and_frame_taxonomy.md#4-shellbar-2026-06-09), [frame tree plan](2026-06-08_frame_tree_in_meerkat_plan.md), `crates/meerkat/`, `crates/system/session-runtime/src/settings_store.rs`
