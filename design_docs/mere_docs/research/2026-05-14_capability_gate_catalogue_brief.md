...
- [`../implementation_strategy/2026-05-11_typed_action_bus_plan.md`](../implementation_strategy/2026-05-11_typed_action_bus_plan.md) — the bus design these gates plug into. The `PermissionGate` trait already exists in `mere-host-runtime::action_bus` (`PermitEverythingGate`, `RefuseEverythingGate`); this brief specifies the *real* policy gate that replaces them.
...
- [`crates/mere-host-runtime/src/manifest.rs`](../../../crates/mere-host-runtime/src/manifest.rs) — `SessionPolicy.overrides: Vec<SessionPolicyOverride>` is the placeholder this brief fills.
