...
| **p2panda (core/net/sync/blobs/stream)** | Strong adopt-candidate, re-evaluate now. iroh-based, BLAKE3/Ed25519/CBOR/UCAN, modular. May give 80% of the MereEvent DAG for free. |
...
| **UCAN** | Interop envelope. Portable capability sharing and external agents. (p2panda already uses it.) |
