...
- [host_cheap_path_plan](mere_docs/implementation_strategy/2026-06-10_host_cheap_path_plan.md) — move meerkat's DOM panes off the stateless per-frame pipeline onto IncrementalLayout sessions + a laid-out-document query seam; stop the mutation-log leak; C6 wiring parity (IME, on_wheel, pointer cancellation, memoize). *(The serval_host_flip_plan was closed + archived 2026-06-10. C0–C3 done: chrome on a session, frame -40%; C4 chrome queries + C5 workbench on the session.)*
