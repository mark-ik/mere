...
- Next app-state reducer target: keep moving sequentially into the remaining pure `app_ux` seam without moving `GraphBrowserApp`, persistence implementations, or host adapters.
