...
| `nematic.knot`      | InScenePaint*       | `Knot(EngramHandle)`, `DocumentTile(.knot)`          | None                         | per [polyglot-knot design](../../nematic_docs/implementation_strategy/2026-05-08_polyglot_knot_design.md) |
