...
- **Picking engines** is `inker` (routing by pin / type / scheme / override).
  ...
  ([integration plan](../../mere_docs/implementation_strategy/2026-06-02_modular_integration_plan.md) §1.9)
...
[topology doc §9](../../mere_docs/technical_architecture/2026-05-19_workspace_topology_status.md).
