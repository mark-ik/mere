//! Browser-owned durable storage for Graphshell's Muniment documents.
//!
//! Muniment defines the byte-store contract. Graphshell chooses IndexedDB as
//! its browser host realization and keeps that browser API out of Mere.
